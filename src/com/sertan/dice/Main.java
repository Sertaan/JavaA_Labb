...
import static com.sertan.dice.DbUtils.getPlayers;
...
public class Main extends Colors {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Error fetching players from the database: " + e.getMessage());
            ...
            try (Scanner sc = new Scanner(System.in)) {
                ...
                for (int i = 0; i < numberOfDice; i++) {
                    ...
                    // Uppdatera summerande poäng för varje spelare
                    player1sum += dice1;
                    player2sum += dice2;
